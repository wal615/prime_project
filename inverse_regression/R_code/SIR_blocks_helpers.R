...
calculate_sufficient_data_block <- function(input_file, ncol, slice_level, header){
...
## based on Zhang (2016)
SIR_blocks <- function (input_file, ncol, slice_level, header) {
  sufficient_stat <- calculate_sufficient_data_block(input_file, ncol, slice_level, header)
