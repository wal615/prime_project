...
save(result_list_fixed_fixed_main, file = "./result/simulation_decorrelation/simulation_result_list_fixed_fixed_un_chi_main_interm_1_inter_1_m_0.015_interaction")
...
result_list_fixed_fixed_total <- mapply(FUN = simulation_fn,
                                        ...
                                        MoreArgs = list(p = p,
                                                        ...
                                                        interaction_m = 0),
                                        SIMPLIFY = FALSE)
save(result_list_fixed_fixed_total, file = "./result/simulation_decorrelation/simulation_result_list_fixed_fixed_un_chi_total_inter_1_svd_0.5_m_0.015_interaction")