...
all_args <- expand.grid(structure = "un", p = p, n = n_total, pre_cor = list(pre_cor))
...
uncorr_args <- all_args[,c("p"),drop = FALSE]
...
save(result_list_fixed_fixed_main, file = "./result/simulation_decorrelation/simulation_result_list_fixed_fixed_un_chi_main_interm_0_inter_1_0_interaction_main_1_10_v_2")
