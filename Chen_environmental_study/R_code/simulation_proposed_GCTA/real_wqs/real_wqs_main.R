...
result_list_real_wqs_main <- mapply(FUN = fit_real_data_fn,
...
saveRDS(result_list_real_wqs_main, file = "./result/simulation_proposed_GCTA_paper/result_list_real_wqs_main")
