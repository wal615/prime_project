...
result_name <- paste("lm_result_list_fixed_sub", dist, "structure", structure, "main", main_fixed_var, "inter",inter_fixed_var, 
                     "n", paste(n_total, collapse = "_"), "p", p, "rho_e", paste(rho_e,collapse = "_"), "sparse_ratio", sparse_ratio, 
...
# run simulation
result_list <- mapply(FUN = simulation_var_est_lm_fn,
