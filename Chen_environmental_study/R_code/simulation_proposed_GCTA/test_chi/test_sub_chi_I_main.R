...
result_name <- "result_list_fixed_sub_chi_I_main_0.5_inter_0_main"
...
pro <- 0.75
bs <- FALSE
gene_data_args_un <- expand.grid(structure = "I", p = p, n = n_total)
...
# run simulation
result_list_fixed_sub_chi_I_main_0.5_inter_0_main <- mapply(FUN = simulation_var_est_fn,
...
saveRDS(result_list_fixed_sub_chi_I_main_0.5_inter_0_main, file = paste0(result_folder_path, result_name))
