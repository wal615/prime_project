...
# inter_std
result_list_fixed_PCB_main_1_inter_1_total_dim_inter_std <- mapply(FUN = simulation_fn,
...
saveRDS(result_list_fixed_PCB_main_1_inter_1_total_dim_inter_std, file = "./result/simulation_proposed_GCTA_paper/PCB_std_est/result_list_fixed_PCB_main_1_inter_1_total_dim_inter_std")
...
saveRDS(result_list_fixed_PCB_main_1_inter_1_total_dim, file = "./result/simulation_proposed_GCTA_paper/PCB_std_est/result_list_fixed_PCB_main_1_inter_1_total_dim")
...
result_list_fixed_PCB_main_1_inter_0_total_dim_inter_std <- mapply(FUN = simulation_fn,
                                                gene_data_args = gene_data_args,
                                                dim_red_args = dim_red_args,
                                                MoreArgs = list(p = p,
                                                                tran_fun = null_tran,
...
saveRDS(result_list_fixed_PCB_main_1_inter_0_total_dim_inter_std, file = "./result/simulation_proposed_GCTA_paper/PCB_std_est/result_list_fixed_PCB_main_1_inter_0_total_dim_inter_std")
...
saveRDS(result_list_fixed_PCB_main_1_inter_0_total_dim, file = "./result/simulation_proposed_GCTA_paper/PCB_std_est/result_list_fixed_PCB_main_1_inter_0_total_dim")
