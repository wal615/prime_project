...
saveRDS(result_list_fixed_PCB_main_1_inter_1_total_inter_std, file = "./result/simulation_proposed_GCTA_paper/result_list_fixed_PCB_main_1_inter_1_total_inter_std")
...
saveRDS(result_list_fixed_PCB_main_1_inter_1_total, file = "./result/simulation_proposed_GCTA_paper/result_list_fixed_PCB_main_1_inter_1_total")
...
saveRDS(result_list_fixed_PCB_main_1_inter_0_total_inter_std, file = "./result/simulation_proposed_GCTA_paper/result_list_fixed_PCB_main_1_inter_0_total_inter_std")
...
saveRDS(result_list_fixed_PCB_main_1_inter_0_total, file = "./result/simulation_proposed_GCTA_paper/result_list_fixed_PCB_main_1_inter_0_total")
