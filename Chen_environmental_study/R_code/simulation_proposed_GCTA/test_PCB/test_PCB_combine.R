...
result_list_fixed_PCB_inter_1_combine <- mapply(FUN = simulation_fn,
...
saveRDS(result_list_fixed_PCB_inter_1_combine, file = "./result/simulation_proposed_GCTA_paper/result_list_fixed_PCB_inter_1_combine")
...
gene_data_args <- gene_data_args %>% split(x = ., f = seq(nrow(gene_data_args))) # generate a list from each row of a dataframe
uncorr_args <- list(p = p)
result_list_fixed_PCB_inter_0_combine <- mapply(FUN = simulation_fn,
                                                gene_data_args = gene_data_args,
                                                MoreArgs = list(p = p,
                                                                tran_fun = null_tran,
                                                                combine = combine,
...
saveRDS(result_list_fixed_PCB_inter_0_combine, file = "./result/simulation_proposed_GCTA_paper/result_list_fixed_PCB_inter_0_combine")
