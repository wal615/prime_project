...
```{r main_fixed_fixed_chi_combine, fig.cap = "Total effect of chi fixed main and interaction"}

plot_chi_fixed_fixed_main_combine
...
```{r main_fixed_random_chi_combine, fig.cap = "Total effect of chi fixed main and random interaction"}

plot_chi_fixed_random_main_combine
...
```{r main_random_random_chi_combine, fig.cap = "Total effect of chi random main and interaction"}

plot_chi_random_random_main_combine
