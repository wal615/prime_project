...
plot_fixed_fixed_main <- tidyr::gather(main, ends_with("main"), key = "method", value = "value") %>%
...
plot_fixed_fixed_inter <- tidyr::gather(inter, ends_with("interaction"), key = "method", value = "value") %>%
                          ggplot(., aes(x = method, y = value, fill = method)) +
                          geom_violin(alpha = 0.2) +
                          geom_boxplot(alpha = 0.7) +
                          facet_wrap(facets = vars(main_fixed, inter_fixed, corr), ncol =3 , scales = "free", labeller  = "label_both")
...
load(file = "./result/simulation_result_list_fixed_random")
table_fixed_random <- rbindlist(result_list_fixed_random)

main <- table_fixed_random[true_main != 0, -c(2,4,6)]
plot_fixed_random_main <- tidyr::gather(main, ends_with("main"), key = "method", value = "value") %>%
  ggplot(., aes(x = method, y = value, fill = method)) +
  geom_violin(alpha = 0.2) +
  geom_boxplot(alpha = 0.7) +
  facet_wrap(facets = vars(main_fixed, inter_fixed, corr), ncol =3 , scales = "free", labeller  = "label_both")
...
plot_fixed_random_inter <- tidyr::gather(inter, ends_with("interaction"), key = "method", value = "value") %>%
  ggplot(., aes(x = method, y = value, fill = method)) +
  geom_violin(alpha = 0.2) +
  geom_boxplot(alpha = 0.7) +
  facet_wrap(facets = vars(main_fixed, inter_fixed, corr), ncol =3 , scales = "free", labeller  = "label_both")
...
load(file = "./result/simulation_result_list_random_random")
table_random_random <- rbindlist(result_list_random_random)

main <- table_random_random[true_main != 0, -c(2,4,6)]
plot_random_random_main <- tidyr::gather(main, ends_with("main"), key = "method", value = "value") %>%
  ggplot(., aes(x = method, y = value, fill = method)) +
  geom_violin(alpha = 0.2) +
  geom_boxplot(alpha = 0.7) +
  facet_wrap(facets = vars(main_fixed, inter_fixed, corr), ncol =3 , scales = "free", labeller  = "label_both")
...
plot_random_random_inter <- tidyr::gather(inter, ends_with("interaction"), key = "method", value = "value") %>%
  ggplot(., aes(x = method, y = value, fill = method)) +
  geom_violin(alpha = 0.2) +
  geom_boxplot(alpha = 0.7) +
  facet_wrap(facets = vars(main_fixed, inter_fixed, corr), ncol =3 , scales = "free", labeller  = "label_both")
