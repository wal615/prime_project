...
nor_50 <- read.csv("./result/simulation_proposed_GCTA_paper/var_est/combined_effects_GCTA_rr/decor_None_sparse_None_normal_structure_I_main_0.5_inter_0_n_50_75_100_150_200_p_100_rho_e_0.5_decor_FALSE_subpro_1012_iter_1_nsub_0_GCTA_kernel_GCTA_rr_kernel_est_main_c_betam_8_c_betai_2_Var_null/rho_e_0.5_n_50_pro_1012_iteration_1.csv",
                   stringsAsFactors = F)
n <- nor_50[1,"n"]
...
## 75
nor_75 <- read.csv("./result/simulation_proposed_GCTA_paper/var_est/combined_effects_GCTA_rr/decor_None_sparse_None_normal_structure_I_main_0.5_inter_0_n_50_75_100_150_200_p_100_rho_e_0.5_decor_FALSE_subpro_1012_iter_1_nsub_0_GCTA_kernel_GCTA_rr_kernel_est_main_c_betam_8_c_betai_2_Var_null/rho_e_0.5_n_75_pro_1012_iteration_1.csv",
                   stringsAsFactors = F)
n <- nor_75[1,"n"]
...
## 100
nor_100 <- read.csv("./result/simulation_proposed_GCTA_paper/var_est/combined_effects_GCTA_rr/decor_None_sparse_None_normal_structure_I_main_0.5_inter_0_n_50_75_100_150_200_p_100_rho_e_0.5_decor_FALSE_subpro_1012_iter_1_nsub_0_GCTA_kernel_GCTA_rr_kernel_est_main_c_betam_8_c_betai_2_Var_null/rho_e_0.5_n_100_pro_1012_iteration_1.csv",
                   stringsAsFactors = F)
n <- nor_100[1,"n"]
...
## 150
nor_150 <- read.csv("./result/simulation_proposed_GCTA_paper/var_est/combined_effects_GCTA_rr/decor_None_sparse_None_normal_structure_I_main_0.5_inter_0_n_50_75_100_150_200_p_100_rho_e_0.5_decor_FALSE_subpro_1012_iter_1_nsub_0_GCTA_kernel_GCTA_rr_kernel_est_main_c_betam_8_c_betai_2_Var_null/rho_e_0.5_n_150_pro_1012_iteration_1.csv",
                    stringsAsFactors = F)
n <- nor_150[1,"n"]
...
## 200
nor_200 <- read.csv("./result/simulation_proposed_GCTA_paper/var_est/combined_effects_GCTA_rr/decor_None_sparse_None_normal_structure_I_main_0.5_inter_0_n_50_75_100_150_200_p_100_rho_e_0.5_decor_FALSE_subpro_1012_iter_1_nsub_0_GCTA_kernel_GCTA_rr_kernel_est_main_c_betam_8_c_betai_2_Var_null/rho_e_0.5_n_200_pro_1012_iteration_1.csv",
                    stringsAsFactors = F)
n <- nor_200[1,"n"]
