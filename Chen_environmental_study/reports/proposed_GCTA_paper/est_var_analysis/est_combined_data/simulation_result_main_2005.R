...
## Eg + GCTA main
#############################################################################################################################
result_path <- "decor_method_None_result_list_fixed_sub_chi_structure_un_main_0.5_inter_0_n_100_150_300_p_300_rho_e_0.5_dim_red_coeff__decor_FALSE_subpro_0_iter_100_nsub_1_EigenPrism_kernel_GCTA_kernel_est_main_year_2005"
...
result_path <- "decor_method_None_result_list_fixed_sub_normal_structure_un_main_0.5_inter_0_n_100_150_300_p_300_rho_e_0.5_dim_red_coeff__decor_FALSE_subpro_0_iter_100_nsub_1_EigenPrism_kernel_GCTA_kernel_est_main_year_2005"
file_list_all <- list.files(paste0("./", result_path, "/")) %>% paste0(paste0("./", result_path, "/"),.)
file_list <- file_list_all
sub_result <- lapply(file_list, function (x) {read.csv(x, header = TRUE, stringsAsFactors = FALSE)}) %>% rbindlist(., fill = TRUE)
# replace the 999 as NA 
