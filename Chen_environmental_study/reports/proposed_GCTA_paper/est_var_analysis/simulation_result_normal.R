...
#############################################################################################################################
file_list_all <- list.files("./result/simulation_proposed_GCTA_paper/var_est/result_list_fixed_sub_normal_un_main_0.5_inter_0.1_total/") %>%
  paste0("./result/simulation_proposed_GCTA_paper/var_est/result_list_fixed_sub_normal_un_main_0.5_inter_0.1_total/",.)
...
hist_plot_total_original_scale <- ggplot(data = hist_table, aes(x=prop_total, fill=i)) + 
  ...
  ggsave("./reports/proposed_GCTA_paper/est_var_analysis/normal_original_total.pdf", 
...
ggsave("./reports/proposed_GCTA_paper/est_var_analysis/normal_log_total.pdf", 
       plot = hist_plot_total_log_scale, 
       dpi = 1200,width = 10)

write.csv(sub_total, file = "./result/simulation_proposed_GCTA_paper/var_est/result_list_fixed_sub_normal_un_main_0.5_inter_0.1_total/sub_sampling_normal_total.csv", row.names = FALSE)
