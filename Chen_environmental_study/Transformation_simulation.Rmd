...
- For main and interaction effects ($\beta^{(main)}$ and $\beta^{(inter)}$), 80 groups of values are randomly generated from 2 normal distributions 
...
- Histogram plots are about the empirical distribution of the true variances, GCTA estimator and Proposed estimation
