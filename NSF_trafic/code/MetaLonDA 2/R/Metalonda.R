...
metalonda = function(Count, Time, Group, ID, n.perm = 500, fit.method = "nbinomial", 
                      points, text = 0, parall = FALSE, cores = 10, pvalue.threshold = 0.05, 
                     ...
                     prefix = "Test")
{
  ...
  ## Permutation 
  perm  = permutation(aggregate.df, n.perm, fit.method, points, lev = group.levels, parall = parall, cores)
...
#' }
#' @export
metalondaAll = function(Count, Time, Group, ID, n.perm = 501,
