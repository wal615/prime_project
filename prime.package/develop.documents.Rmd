...
- [R packages by Hadley Wickham](http://r-pkgs.had.co.nz/intro.html). In this book the author breaks the R packages into several parts and gives details introduction and descriptions. This document is based on the structure of this book. 
