...
save(result_list_fixed_fixed_main, file = "./result/simulation_test_inter/simulation_result_list_fixed_fixed_cs_chi_main_interm_0_inter_0_mean_0")
...
result_list_fixed_fixed_total <- mapply(FUN = simulation_fn,
                                        ...
                                        MoreArgs = list(p = p,
                                                        ...
                                                        interaction_m = 0),
                                        SIMPLIFY = FALSE)
save(result_list_fixed_fixed_total, file = "./result/simulation_test_inter/simulation_result_list_fixed_fixed_cs_chi_total_inter_0_svd_0.5_mean_0")